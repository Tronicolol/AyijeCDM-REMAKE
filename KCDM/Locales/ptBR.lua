...
L["use /kcdm"] = "use /kcdm"
L["Edit Mode locked - use /kcdm"] = "Modo de Edição travado - use /kcdm"
L["Cooldown Viewer settings are managed by /kcdm."] = "As configs do Visualizador de Cooldowns são geridas pelo /kcdm."
