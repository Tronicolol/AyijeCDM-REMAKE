...
L["use /kcdm"] = "benutze /kcdm"
L["Edit Mode locked - use /kcdm"] = "Bearbeitungsmodus gesperrt – benutze /kcdm"
L["Cooldown Viewer settings are managed by /kcdm."] = "Abklingzeitenanzeige-Einstellungen werden durch /kcdm verwaltet."
