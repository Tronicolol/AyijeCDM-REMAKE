...
L["use /kcdm"] = "используйте /kcdm"
L["Edit Mode locked - use /kcdm"] = "Режим редактирования заблокирован — используйте /kcdm"
L["Cooldown Viewer settings are managed by /kcdm."] = "Настройки трекера восстановления способностей управляются через /kcdm."
...
-----------------------------------------------------------------------
-- KCDM_Options/GroupEditorShared.lua
-----------------------------------------------------------------------
...
-----------------------------------------------------------------------
-- KCDM_Options/CooldownGroups.lua
-----------------------------------------------------------------------
...
-----------------------------------------------------------------------
-- KCDM_Options/EditModeOverlay.lua
-----------------------------------------------------------------------
...
-----------------------------------------------------------------------
-- KCDM_Options/Resources_Conditions.lua
-----------------------------------------------------------------------
...
-----------------------------------------------------------------------
-- KCDM_Options/Resources_Load.lua
-----------------------------------------------------------------------
