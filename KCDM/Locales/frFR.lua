...
L["use /kcdm"] = "utilisez /kcdm"
L["Edit Mode locked - use /kcdm"] = "Mode édition verrouillé – utilisez /kcdm"
L["Cooldown Viewer settings are managed by /kcdm."] = "Les paramètres de la vue de temps de recharge sont gérés par /kcdm."
