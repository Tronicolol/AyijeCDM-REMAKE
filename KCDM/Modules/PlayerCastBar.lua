...
local CASTBAR_BG_TEXTURE = "Interface\\AddOns\\KCDM\\Media\\Textures\\blizzcastback"
...
function CDM:CreatePlayerCastBar()
    ...
    local container = CreateFrame("Frame", "KCDM_CastBarContainer", UIParent)
    container:SetClampedToScreen(true)

    self.castBarContainer = container

    local f = CreateFrame("Frame", "KCDM_CastBar", container)
