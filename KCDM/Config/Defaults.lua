...
CDM.defaults = {
    ...
    -- Cooldown icon appearance
    -- White preserves the existing appearance until customized.
    cooldownIconColor = { r = 1, g = 1, b = 1, a = 1 },
    ...
    -- Pandemic Glow override
    pandemicGlowEnabled = false,
    pandemicGlowType = "button", -- "pixel", "autocast", "button", "proc"
    pandemicGlowColor = { r = 0.10, g = 0.90, b = 0.90, a = 1 },
