...
if LSM then
    LSM:Register("border", "KCDM_Thin", "Interface\\AddOns\\KCDM\\Media\\Borders\\KCDM_Thin.tga")
    LSM:Register("border", "KCDM_Empty", "Interface\\AddOns\\KCDM\\Media\\Borders\\KCDM_Empty.tga")
...
local function GetBorderDef()
    local borderKey = CDM_C.GetConfigValue("borderFile", "KCDM_Thin")
    local borderFile
    if LSM then
    ...
    if not borderFile and borderKey ~= "None" then
        borderFile = "Interface\\AddOns\\KCDM\\Media\\Borders\\KCDM_Thin.tga"
    end
