...
local function CreateBarColorPicker(parent, label, classKey, barKey, settingKey)
    ...
    local nameText = row:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
...
local function BuildTicksSection(rc, classKey, barKey, startYOff)
    ...
    local function Rebuild()
        ...
        local colorLabel = colorRow:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
        ...
        local placeLabel = container:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
...
local function CreateResourcesTab(page, tabId)
    ...
    local rightPlaceholder = displayPage:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local condPlaceholder = condPage:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local loadPlaceholder = loadPage:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local function ShowBarSettings(classKey, barKey)
        ...
        if barKey == "Stagger" then
            ...
            for idx, tier in ipairs(CDM.CONST.STAGGER_TIERS) do
                local tierLabel = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
        ...
        local barTextureLabel = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
        ...
        local bgTextureLabel = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
        ...
        local anchorToLabel = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
        ...
        elseif isBarAnchor then
            ...
            local stackDirLabel = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
            ...
            local apLabel = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
            ...
            local rpLabel = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
        ...
        local tagAnchorLabel = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local function ShowGlobalSettings()
        ...
        local fallbackLabel = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
        ...
        local comingSoon = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
