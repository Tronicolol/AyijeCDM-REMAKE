...
local function CreateImportExportTab(page, tabId)
    ...
    local exportDesc = page:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local exportBoxLabel = page:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local importDesc = page:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local importStatus = page:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
