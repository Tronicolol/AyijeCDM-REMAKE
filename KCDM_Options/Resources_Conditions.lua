...
local function ShowBarConditions(condPage, condManager, classKey, barKey)
    ...
    for ruleIdx, rule in ipairs(conditions) do
        ...
        local ruleLabel = ruleHeader:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
        ...
        if isPipBar then
            local targetLabel = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
        ...
        local ifLabel = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
        ...
        local thenLabel = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
