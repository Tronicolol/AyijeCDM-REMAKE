...
function Shared.ApplyRemoveButtonText(btn)
    local text = btn:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
...
function Shared.CreateExpandableHeader(parent, yOff, isExpanded, displayName, isSelected)
    ...
    local nameText = row:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
...
function Shared.SetupRenameEditBox(headerRow, bgLeft, bgRight, nameText, currentName, onCommit, onCancel)
    ...
    editBox:SetFontObject("KCDM_Font14")
...
function Shared.RenderSpellPicker(config)
    ...
    if config.isCacheMissing then
        local msg = rc:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
    ...
    elseif not config.spells or #config.spells == 0 then
        ...
        for _, entry in ipairs(config.spells) do
            ...
            local label = row:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
...
function Shared.BuildTextOverrideWidgets(rc, yOff, cfg)
    ...
    if cfg.showHeader then
        yOff = yOff - 10
        local ovHeader = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font18")
    ...
    if useTextOv then
        ...
        local cdColorLabel = rc:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
        ...
        local posLabel = rc:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
...
function Shared.CreateGroupEditorPools(parent, config)
    ...
    local emptyRowPool = Shared.CreateWidgetPool(function(p)
        ...
        local t = f:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
    ...
    local spellRowPool = Shared.CreateWidgetPool(function(p)
        ...
        local nameText = row:CreateFontString(nil, "OVERLAY", "KCDM_Font12")
        nameText:SetJustifyH("LEFT")
...
function Shared.CreateBarRowPool(_, config)
    ...
    return Shared.CreateWidgetPool(function(p)
        ...
        local nameText = bar:CreateFontString(nil, "OVERLAY", "KCDM_Font12")
...
function Shared.RenderGroupSettingsPanel(config)
    ...
    local nameHeader = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font18")
    ...
    local growLabel = rc:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
    ...
    yOff = yOff - 10
    local textHeader = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font18")
    ...
    local secColorLabel = rc:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
    ...
    local secPosLabel = rc:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
    ...
    yOff = yOff - 10
    local anchorHeader = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font18")
    ...
    local anchorTargetLabel = rc:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
    ...
    local anchorLabel = rc:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
    ...
    local relLabel = rc:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
