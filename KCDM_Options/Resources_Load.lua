...
local function ShowBarLoad(loadPage, loadManager, classKey, barKey)
    ...
    local modeLabel = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local combatLabel = condContainer:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    if #specs > 1 then
        local specLabel = condContainer:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
