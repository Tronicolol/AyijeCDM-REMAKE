...
function UI.CreateColorSwatch(parent, label, key, scope)
    ...
    local text = frame:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
...
function UI.CreateModernSlider(parent, label, minVal, maxVal, currentVal, onValueChanged, labelWidth, sliderWidth)
    ...
    panel.Label = panel:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
...
function UI.CreateHeader(parent, text, anchorFrame, yOffset)
    return CreateSectionHeader(parent, text, anchorFrame, yOffset, "KCDM_Font18", -15, -10)
end

function UI.CreateSubHeader(parent, text, anchorFrame, yOffset)
    return CreateSectionHeader(parent, text, anchorFrame, yOffset, "KCDM_Font14", -12, -10)
end
...
function UI.AttachPlaceholder(editBox, text)
    local ph = editBox:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
