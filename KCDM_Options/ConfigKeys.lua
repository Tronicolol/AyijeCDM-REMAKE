...
do
    ...
    for catName, catDef in pairs(ns.ConfigKeys.categories) do
        for _, key in ipairs(catDef.keys) do
            if keysInCategories[key] then
                print("|cffff6600[KCDM] ConfigKeys: '" .. key .. "' in both '" .. keysInCategories[key] .. "' and '" .. catName .. "'|r")
            end
    ...
    for key in pairs(defaults) do
        if not keysInCategories[key] then
            print("|cffff6600[KCDM] ConfigKeys: default key '" .. key .. "' not in any export category|r")
        end
    end

    for key, catName in pairs(keysInCategories) do
        if defaults[key] == nil then
            print("|cffff6600[KCDM] ConfigKeys: export key '" .. key .. "' (in '" .. catName .. "') has no default|r")
        end
    end
end
