...
local function CreatePolicyRow(parent, contentWidth)
    ...
    local label = row:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
...
local function CreateEditModeOverlay()
    ...
    for i, letter in ipairs(headerLetters) do
        local fs = headerCluster:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
        fs:SetText(letter)
    ...
    local presetBanner = window:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
