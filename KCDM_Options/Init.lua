...
local Font12 = _G["KCDM_Font12"] or CreateFont("KCDM_Font12")
Font12:SetFont(STANDARD_TEXT_FONT, 12, "")
if CDM_C.ApplyShadow then
    CDM_C.ApplyShadow(Font12)
end

local Font14 = _G["KCDM_Font14"] or CreateFont("KCDM_Font14")
Font14:SetFont(STANDARD_TEXT_FONT, 14, "")
if CDM_C.ApplyShadow then
    CDM_C.ApplyShadow(Font14)
end

local Font18 = _G["KCDM_Font18"] or CreateFont("KCDM_Font18")
...
StaticPopupDialogs["KCDM_CONFIRM_COPY_PROFILE"] = {
...
StaticPopupDialogs["KCDM_CONFIRM_DELETE_PROFILE"] = {
