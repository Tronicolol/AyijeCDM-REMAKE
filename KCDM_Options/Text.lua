...
local function FontDropdown(rc, yOff, page)
    local lbl = rc:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    lbl:SetText(L["Font"])
...
local function BuildEssential(subPage, page)
    local rc, sc = UI.MakeSubPageScroll(subPage, "KCDM_Text_EssentialScrollFrame")
    local yOff = 0
...
local function BuildUtility(subPage, page)
    local rc, sc = UI.MakeSubPageScroll(subPage, "KCDM_Text_UtilityScrollFrame")
    local yOff = 0
...
local function BuildBuffIcons(subPage, page)
    local rc, sc = UI.MakeSubPageScroll(subPage, "KCDM_Text_BuffIconsScrollFrame")
    local yOff = 0
...
local function BuildBuffBars(subPage, page)
    local rc, sc = UI.MakeSubPageScroll(subPage, "KCDM_Text_BuffBarsScrollFrame")
    local yOff = 0
