...
local function CreateBlacklistOverlay()
    ...
    local titleText = window:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local addLabel = window:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local statusText = window:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
...
local function CreateTrinketsTab(page, tabId)
    local scrollChild = UI.CreateScrollableTab(page, "KCDM_TrinketsScrollFrame", 700, 500)
    ...
    local lblMode = scrollChild:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local lblRow = scrollChild:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local lblPos = scrollChild:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
