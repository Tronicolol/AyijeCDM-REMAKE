...
local SCROLL_FRAME_NAMES = {
    glow = "KCDM_GlowScrollFrame",
    racials = "KCDM_RacialsScrollFrame",
    defensives = "KCDM_DefensivesScrollFrame",
    trinkets = "KCDM_TrinketsScrollFrame",
    resources = "KCDM_ResourcesScrollFrame",
    bars = "KCDM_BarsScrollFrame",
    castbar = "KCDM_CastBarScrollFrame",
    buffgroups = "KCDM_BuffGroupsLeftScroll",
}
...
local function HideConfigPopups()
    ...
    StaticPopup_Hide("KCDM_CONFIRM_DELETE_GROUP")
    StaticPopup_Hide("KCDM_CONFIRM_DELETE_CD_GROUP")
    StaticPopup_Hide("KCDM_CONFIRM_DELETE_BAR_GROUP")
end
...
local categoryHeaders = {
    ...
    { label = L["Features"], tabs = {"defensives", "racials", "resources", "trinkets", "castbar"} },
...
local function CreateConfigFrame()
    ...
    ConfigFrame:Hide()
    tinsert(UISpecialFrames, "KCDMConfigFrame")
    ...
    local title = titleContainer:CreateFontString(nil, "OVERLAY", "KCDM_Font18")
    ...
    local function AddNav(id, label, y, indent)
        ...
        btn.Text = btn:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
