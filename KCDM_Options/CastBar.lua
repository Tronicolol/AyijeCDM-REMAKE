...
local function CreateOverrideRow(parent)
    ...
    local function MakeFieldRow(yOff, labelText, callbackKey)
        ...
        local lbl = fieldsFrame:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
...
local function BuildAnchoringPage(parent)
    ...
    local scrollChild, scrollFrame = UI.CreateScrollableTab(parent, "KCDM_CastBarAnchoringScrollFrame", 1400, 460)
    ...
    local anchorLabel = scrollChild:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local anchorPointLabel = scrollChild:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local targetPointLabel = scrollChild:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local addLabel = overrideArea:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
...
local function CreateCastBarTab(page, tabId)
    ...
    local scrollChild, scrollFrame = UI.CreateScrollableTab(subTabs.subPages.general, "KCDM_CastBarScrollFrame", 700, 370)
    scrollFrame:ClearAllPoints()
    scrollFrame:SetPoint("TOPLEFT", 0, 0)
    scrollFrame:SetPoint("BOTTOMRIGHT", -10, 20)
    scrollChild:ClearAllPoints()
    ...
    local iconPosLabel = scrollChild:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local textureLabel = lsmGroup:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
    ...
    local bgTextureLabel = lsmGroup:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
