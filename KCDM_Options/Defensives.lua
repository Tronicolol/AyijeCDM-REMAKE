...
local function CreateSpellsOverlay()
    ...
    local statusText = addRow:CreateFontString(nil, "OVERLAY", "KCDM_Font14")
...
local function CreateDefensivesTab(page, tabId)
    local scrollChild = UI.CreateScrollableTab(page, "KCDM_DefensivesScrollFrame", 700, 370)
    ...
    local lblChargePos = scrollChild:CreateFontString(nil, "ARTWORK", "KCDM_Font14")
